    ...
    public Conversation conversationAddTransferAgentInformation(Conversation conversation
        ...
        conversation.setTransferAgentInformation(
                TransferAgentInformation.builder()
                        ...
                        .email(inferenceOutResponse.getMessageJson().getEmail())//Used for HSM11 Only
                        .campaign(inferenceOutResponse.getMessageJson().getCampaign())
                        .clientRequest(inferenceOutResponse.getMessageJson().getSubject())
                        .subject(inferenceOutResponse.getMessageJson().getSubject())
                        .channel(inferenceOutResponse.getMessageJson().getChannel())
                        .chatSessionId(inferenceOutResponse.getSessionId())//SessionId or UUID coming from Studio7
                        .dvaPath(inferenceOutResponse.getMessageJson().getDvaPath())
                        .build()
        );
        return conversation;
    }
